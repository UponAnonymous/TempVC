...
public interface MongoStorage {
    ...
    /**
     * Execute a raw database request against the collection for the provided type.
     *
     * @param type     mapped class
     * @param consumer callback receiving the collection and key metadata
     */
    void processRequest(Class<?> type, dev.starless.mongo.RequestConsumer consumer);
